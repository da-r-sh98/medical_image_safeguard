            ...
            <LayoutTemplate>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li><a href="pathome.jsp?pg=mya"><i class="icon-user"></i> Upload Files </a>
                            </li>
                            <li class="divider"></li>
        ...
        <div id="left" style="margin-top: 50px;">
            <div class="media user-media well-small">
             ...
             <a class="user-link" href="#">
                 <img  ID="im" class="media-object img-thumbnail user-img" alt="User Picture" width="100px" height="100%" src="img/u.jpg"/>
                </a>
                <br />
        ...
        <div class="col-lg-12">
            <div class="box primary">
                ...
                if(request.getParameter("pg")!=null)
                  ...
                  {
                  %>
                  <%@include file="DoctorDetails.jsp" %>
                    <%
                  }
                  ...
                  {
                  %>
                  <%@include file="View Appointments.jsp" %>
                    <%
                  }
                  if(pg.equals("ch"))
                  {
                  ...
                  {
                   %>
                   <%@include file="SearchDoctors.jsp" %>
                    <%
                  }
